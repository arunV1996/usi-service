...
import * as remitterService from '../services/usi/remitterService';
...
export const create = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    respond(req, res, await remitterService.createRemitter(ctx(req), pick(req.body, REMITTER_FIELDS)));
  } catch (e) {
    next(e);
  }
};
...
export const search = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    respond(req, res, await remitterService.searchRemitter(ctx(req), pick(req.body, SEARCH_FIELDS)));
  } catch (e) {
    next(e);
  }
};
...
export const update = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    respond(req, res, await remitterService.updateRemitter(ctx(req), pick(req.body, UPDATE_FIELDS)));
  } catch (e) {
    next(e);
  }
};
...
export const verify = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    respond(
      req,
      res,
      await remitterService.verifyRemitter(ctx(req), {
